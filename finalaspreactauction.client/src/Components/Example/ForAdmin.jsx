...
function ForAdmin() {
  ...
  @keyframes shine {
    ...
    return (
        <section>
            <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 rounded p-2" style={{ backgroundColor:"#A7C7E7"} }>
                <header>
                    <h2 className="text-xl font-bold text-gray-900 sm:text-3xl" style={{ fontFamily: 'Roboto'}}>Car Collection</h2>
                    <p className="mt-4 max-w-md text-gray-500" style={{ fontFamily: 'Cascadia Code'} }>
                        Here is a list of available cars.<br/> Admins can delete or edit car data.
                    </p>
                </header>
