...
namespace Auction.Entities.Migrations
{
    ...
    [Migration("20250516081016_InitialCreate23")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auction.Entities.Entities.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Auction.Entities.Entities.Vehicle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Auction.Entities.Entities.Winner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Auction.Entities.Entities.Favorite", b =>
                {
                    b.HasOne("FinalAspReactAuction.Server.Entities.Car", "Car")
                        .WithMany()
                        .HasForeignKey("CarId")
